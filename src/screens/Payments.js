	...
	const Item = ({ item }) => (
		...
		>
			<View style={{ flexDirection: "row", justifyContent: "space-between" }}>
				...
				>
					<Text style={styles.smallButton}>View Details</Text>
				</TouchableOpacity>
			</View>
			<Spacer bottom={20} />
			<View style={{ flexDirection: "row", justifyContent: "space-between" }}>
				<View>
					<Text style={styles.flatlistSubHeading}>Status</Text>
					<Text style={styles.flatlistText}>{item.status}</Text>
				</View>
				<View>
					<Text style={styles.flatlistSubHeading}>Total Amount</Text>
					<Text style={styles.flatlistText}>{item.totalAmount}</Text>
				</View>
				<View>
					<Text style={styles.flatlistSubHeading}>Due Amount</Text>
			...
			<View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
				<View>
					<Text style={styles.flatlistSubHeading}>Issued Amount</Text>
					<Text style={styles.flatlistText}>{item.issuedAmount}</Text>
				</View>
				<View>
					<Text style={styles.flatlistSubHeading}>Process Amount</Text>
					<Text style={styles.flatlistText}>{item.processedAmount}</Text>
				</View>
			</View>
		</Pressable>
	);
