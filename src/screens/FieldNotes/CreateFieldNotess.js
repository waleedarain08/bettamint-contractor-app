...
//         onBackdropPress={() => setOpenModal(!openFieldNote)}
//       >
//         <View
//           style={{
//             width: "100%",
...
//                 console.log(scopeValue, selectedProject, item.value);
//                 dispatch(
//                   getFieldNoteCost(
//                     token,
//                     selectedProject,
...
//               value={costCode}
//               onChange={(item) => {
//                 setCostCode(item.value);
//                 // console.log(scopeValue, selectedProject, item.value);
//                 // dispatch(getFieldNoteCost(token, selectedProject,scopeValue, item.value));
//               }}
//             />
//           </View>
//         </View>
